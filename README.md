...
|---|---|---|---|---|
| 1 | ProGesVen v2 | 🟡 En curso | [ver](https://raw.githubusercontent.com/Macora01/ProGesVen/v2/PROGESVEN.md) | Eliminar /admin/diagnostico + cutover dominio ventas.facore.cl. v1.03.00 operativa. |
